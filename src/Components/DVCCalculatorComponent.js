...
function DVCCalculatorComponent(props) {
  ...
  const calculatePointsNeeded = () => {
    ...
    axios.get(`http://192.168.86.28:3001/dvc-calc-api/pointAmount/${selectedViewTypeId}/${checkInDateYear}-${checkInDateMonth}-${checkInDateDay}/${checkOutDateYear}-${checkOutDateMonth}-${checkOutDateDay}`).then(resp => {
